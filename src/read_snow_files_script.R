...
read_snow_files_script <- function(files) {
  ...
  snow_data <- read_delim(path, skip = 14, delim = ",", na = c("-99", "NaN", "")) %>%
    ...
    mutate(water_year = case_when(date <= ymd('2002-09-30') ~ 2002,
                                  date <= ymd('2003-09-30') ~ 2003,
                                  date <= ymd('2004-09-30') ~ 2004,
                                  date <= ymd('2005-09-30') ~ 2005,
                                  date <= ymd('2006-09-30') ~ 2006,
    ...
    mutate(water_year = factor(water_year, levels = c("2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017"))) %>%
